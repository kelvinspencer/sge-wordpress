...
if ( ! class_exists( 'My_Home_Simple_Box_Shortcode' ) ) :
...
class My_Home_Simple_Box_Shortcode {
    ...
    public function init( $opts, $content = null ) {
        ...
        if ( function_exists( 'vc_map_get_attributes') ) {
            $atts = array_merge( $atts, vc_map_get_attributes( 'mh_simple_box', $opts ) );
        }
		...
		<div class="mh-simple-box-wrapper">
			<article class="mh-simple-box <?php echo esc_attr( $class ); ?>">
				<div class="mh-icon-wrapper <?php echo esc_attr( $atts['icon_color'] ); ?>"
					 style="<?php echo esc_attr( $icon_style ); ?>">
					<i class="flaticon-<?php echo esc_attr( $atts['icon'] ); ?>"></i>
				</div>
				<div class="mh-simple-box__content">
					<h3 class="mh-simple-box__heading <?php echo esc_attr( $atts['title_color'] ); ?>"
						style="<?php echo esc_attr( $heading_style ); ?>">
					<?php echo esc_html( $atts['title'] );  ?></h3>
					<div class="mh-simple-box__text <?php echo esc_attr( $atts['text_color'] ); ?>"
					...
					<?php if ( $atts['button_show'] ) : ?>
						<div class="mh-simple-box__btn">
							<a href="<?php echo esc_url( $atts['button_url'] ); ?>"
							   ...
							   class="mdl-button mdl-js-button mdl-js-ripple-effect <?php echo esc_attr( $btn_class ); ?>">
