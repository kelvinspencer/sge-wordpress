...
class ESSBCore {
	...
	public function register_assets() {
		...
		if (essb_option_bool_value('activate_ga_tracking') || essb_option_bool_value('activate_ga_layers')) {
		...
		if (essb_option_bool_value('animate_single_counter') || essb_option_bool_value('animate_total_counter')) {
			...
			essb_depend_load_function('essb_rs_js_add_animation_counter', 'lib/core/resource-snippets/essb_rs_js_add_animation_counter.php');
		}
	...
	public function register_locations() {
		...
		if (!defined('ESSB3_LIGHTMODE')) {
			...
			if (essb_option_bool_value('buddypress_group') || essb_option_bool_value('buddypress_activity')) {
				...
				essb_depend_load_function('essb_bbpress_activate', 'lib/core/integrations/buddypress.php');
