...
if( ! class_exists( 'My_Home_Social_Icons_Widget' ) ) :

	class My_Home_Social_Icons_Widget extends WP_Widget {
		...
		public function widget( $args, $instance ) {
			...
			foreach ( $this->icons as $key => $icon ) :
				...
				if( ! empty( $i ) ) :
					?><a class="mh-social-icon" href="<?php echo esc_url( $i ); ?>" target="_blank"><i class="fa fa-<?php echo $icon; ?>"></i></a><?php
				endif;
			endforeach;
		...
		public function form( $instance ) {
			...
			foreach ( $this->icons as $key => $icon ) : ?>
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id( $key ) ); ?>"><?php echo $key; ?></label>
