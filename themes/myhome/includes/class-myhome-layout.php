...
class My_Home_Layout {
	...
	public function get_top_title_background_image_url() {
		return My_Home_Theme()->settings->get( 'top-title-background-image-url', 'url' );
	}
	...
	public function get_footer_text() {
        ...
        if ( class_exists( 'My_Home_Core' ) && ! empty( My_Home_Core()->lang ) ) {
    ...
    public function get_header_instagram() {
        ...
        if ( class_exists( 'My_Home_Core' ) && ! empty( My_Home_Core()->lang ) ) {
            $header_instagram = apply_filters(
                'wpml_translate_single_string',
                $header_instagram,
                'MyHome Settings',
                'mh-header-instagram'
	...
	public function get_footer_copyright_text() {
        ...
        if ( class_exists( 'My_Home_Core' ) && ! empty( My_Home_Core()->lang ) ) {
            $footer_copyright_text = apply_filters(
                'wpml_translate_single_string',
	...
	public function header_class() {
	    ...
	    if ( is_page() && function_exists( 'get_field' ) ) {
	        array_push( $class, get_field( 'page_header' ) );
        }

        if ( is_singular( 'estate' ) ) {
            $options = get_option( 'myhome_redux' );
            if ( $options['mh-estate_slider'] == 'single-estate-slider' ) {
    ...
    public function agent_mode() {
	    ...
	    return intval( My_Home_Theme()->settings->get( 'agent-panel' ) );
    }
    ...
    public function get_agent_panel_link() {
        ...
        if ( class_exists( 'My_Home_Core') && ! empty( My_Home_Core()->lang ) ) {
            $panel_link .= '?lang=' . My_Home_Core()->lang;
        }
